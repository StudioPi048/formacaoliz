...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Formação Psicogenealogia LIZ 2026 — Turma 2" },
      { property: "og:description", content: "Formação online/ao vivo com Letícia Baccin. Psicogenealogia, Neurociência, Nova Medicina Germânica, Cabalá e mais." },
